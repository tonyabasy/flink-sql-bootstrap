...
像上一篇 [Flink 实时数仓开发实战：像 Hive 那样用 Flink SQL](./01-hive-like-flink-sql.md) 一样，本文也提供了一个示例项目 [Flink SQL Bootstrap Examples - CI/CD](https://github.com/tonyabasy/flink-sql-bootstrap-examples/tree/main/example-cicd) 帮助大家快速搭建本地环境，并一步步演示 CI/CD 流水线。
